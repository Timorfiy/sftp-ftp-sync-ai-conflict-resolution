# Contributing to SFTP/FTP Sync + AI Conflict Resolution

After you've created a branch on your fork with your changes, [open a pull request][pr-link]. 

*Please follow the guidelines given below while making a Pull Request to SFTP/FTP Sync + AI Conflict Resolution*
...
* Target your Pull Request to the `main` branch of [this repository](https://github.com/Timorfiy/sftp-ftp-sync-ai-conflict-resolution)
